                        ...
                        <div
                            ...
                            <button @click="toggleLeftMenu"
                                ...
                                <svg width="8" height="12" viewBox="0 0 8 12" fill="none"
                                    ...
                                    <path d="M7 1L1 6L7 11" stroke="currentColor" stroke-width="2"
        ...
        <div v-if="props.pagination && filterRowCount" class="bh-pagination"
            ...
            <div class="bh-flex bh-items-center bh-flex-wrap bh-flex-col sm:bh-flex-row bh-gap-4">
                <slot name="footerpageinfo" v-if="enablefooterpagination" :paginationInfo="paginationInfo"
                    ...
                    :pageSizeOptions="pageSizeOptions" :currentPageSize="currentPageSize" :stringFormat="stringFormat"
                ...
                <slot name="footerpagination" v-if="enablefooterpagination" :currentPage="currentPage"
                    :maxPage="maxPage" :paging="paging" :movePage="movePage" :nextPage="nextPage"
